...
/** 此处后端没有提供注释 DELETE /api-player/anime/video/delete/file */
export async function deleteVideo(
  ...
  return request<boolean>('/anime/video/delete/file', {
    method: 'DELETE',
    params: {
      ...params,
    },
...
export async function updateVideoName(
  params: { videoId: number; name: string },
  options?: { [key: string]: any },
) {
  const { videoId: param0, ...queryParams } = params;
  return request<boolean>(`/anime/update/video/${param0}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 PUT /api-player/anime/update/video/sort/${param0} */
export async function updateVideoSort(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: { animeId: number },
  body: number[],
  options?: { [key: string]: any },
) {
  const { animeId: param0 } = params;
  return request<API.BaseResponseBoolean>(`/anime/update/video/sort/${param0}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 DELETE /api-player/anime/video/delete/${param0} */
export async function deleteVideoMsg(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.deleteVideoMsgParams,
  options?: { [key: string]: any },
) {
  const { videoId: param0, ...queryParams } = params;
  return request<boolean>(`/anime/video/delete/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  });
