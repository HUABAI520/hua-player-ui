...
import { Dropdown, Flex, MenuProps, theme } from 'antd';
...
interface CommentLineProps {
  ...
  liking: boolean;
  isFather?: boolean;
  handleDelete: (id: number, isFather?: boolean) => void;
}

import { InteractionType } from '@/common/interaction/InteractionType';
import { calculateTimeDifference } from '@/common/utils/DateUtils';
import { ReportForm } from '@/pages/Player/components/ReportForm';
  ...
  ({
    ...
    return (
      <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        ...
        <ReportForm
          contentType={InteractionType.COMMENT}
          item={item}
